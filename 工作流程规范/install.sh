#!/usr/bin/env bash
#
# 工作流程规范 Skill —— 一键安装脚本(跨工具通用)
#
# 支持的 AI 工具(用户级安装):
#   workbuddy    ~/.workbuddy/skills/workflow-standard
#   claude       ~/.claude/skills/workflow-standard
#   codex        ~/.codex/skills/workflow-standard
#   cursor       ~/.cursor/skills/workflow-standard
#
# 用法:
